...
{
    id: 2,
    title: 'Аутсортинг бухгалтерских услуг',
...
{
    id: 3,
    title: 'Подбор системы налогоблажения',
    button_text: 'Запись на консультацию',
    button_action: '',
    slider_src: './images/banner1.png'
},
{
...
function open_menu() {
    ...
    modal_div.className = 'modal_menu'
...
function close_menu() {
    let modal_div = document.querySelector('.modal_menu')
    modal_div.remove()
}
